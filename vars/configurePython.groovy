def call() {
	sh(returnStdout: false, label: "[Python Agent]: Updating references..", script: "apt-get update")
	sh(returnStdout: false, label: "[Python Agent]: Installing git..", script: "apt-get install -y --no-install-recommends git")
